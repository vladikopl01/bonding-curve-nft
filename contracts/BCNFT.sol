...
import {ITokenMetadataResolver} from
    "@animoca/ethereum-contracts/contracts/token/metadata/interfaces/ITokenMetadataResolver.sol";

contract BCNFT is ContractOwnership, ERC721, ERC721Metadata, ERC721MintableOnce {
    constructor(ITokenMetadataResolver metadataResolver)
        ContractOwnership(_msgSender())
        ERC721()
        ERC721Metadata("Bonding Curve NFT", "BCNFT", metadataResolver)
        ERC721MintableOnce()
    {}
}
